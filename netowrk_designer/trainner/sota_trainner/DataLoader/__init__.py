...
def load_imagenet_like(dataset_name, set_name, train_augment, random_erase, auto_augment,
    ...
    if set_name=='train':
        the_dataset = H5Dataset(os.path.join('../../data/', 'imagenet-train-256.h5'), transform=transformer)
    else:
        the_dataset = H5Dataset(os.path.join('../../data/', 'imagenet-val-256.h5'), transform=transformer)
        logging.info(len(the_dataset))
